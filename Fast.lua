...
{
{text = '✭ سورس فولت ✭', url = 't.me/QQVQQS '},
},
{
{text = '✭ مطور الصانع ✭', url = 't.me/YKRKY '},
},
}
...
local T =[[
☆︙[𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝗢𝗟𝗧](t.me/QQVQQS )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/YKRKY '},
},
{
{text = '• تنصيب بوت مدفوع •', url = 't.me/YKRKY'},
},
{
{text = '• قناة التحديثات •', url = 't.me/QQVQQS '},
},
{  
{text = '• 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝗢𝗟𝗧 •', url = 't.me/QQVQQS '},
},
}
local msgg = msg.id/2097152/0.5

...
Bot_Name = (Redis:get(Gold.."Gold:Name:Bot") or "ماتركس")
...
if Redis:get(Gold.."Gold:Game:Smile"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:Smile"..msg.chat_id) then
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
Redis:del(Gold.."Gold:Game:Smile"..msg.chat_id)
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true)  
end
end 
if Redis:get(Gold.."Gold:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:Monotonous"..msg.chat_id) then
Redis:del(Gold.."Gold:Game:Monotonous"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
end 
if Redis:get(Gold.."Gold:Game:alam"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:alam"..msg.chat_id) then
Redis:del(Gold.."Gold:Game:alam"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
end 
if Redis:get(Gold.."Gold:Game:ausm"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:ausm"..msg.chat_id) then
Redis:del(Gold.."Gold:Game:ausm"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
end 
if Redis:get(Gold.."Gold:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:Riddles"..msg.chat_id) then
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
Redis:del(Gold.."Gold:Game:Riddles"..msg.chat_id)
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
end
if Redis:get(Gold.."Gold:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
Redis:del(Gold.."Gold:Game:Meaningof"..msg.chat_id)
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
end
if Redis:get(Gold.."Gold:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:Reflection"..msg.chat_id) then
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
Redis:del(Gold.."Gold:Game:Reflection"..msg.chat_id)
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
end
if Redis:get(Gold.."Gold:Game:Estimate"..msg.chat_id..msg.sender_id.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return send(msg_chat_id,msg_id,"⇜ مايمديك تخمن عدد اكبر من ( 20 ) خمن رقم ما بين ( 1 - 20 )\n","md",true)
end 
local GETNUM = Redis:get(Gold.."Gold:Game:Estimate"..msg.chat_id..msg.sender_id.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Gold.."Gold:SADD:NUM"..msg.chat_id..msg.sender_id.user_id)
Redis:del(Gold.."Gold:Game:Estimate"..msg.chat_id..msg.sender_id.user_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)  
return send(msg_chat_id,msg_id,"⇜ مبروك فزت وخمنت الرقم الصحيح\n⇜ تم اضافة لك ( 5 ) نقاط \n✓","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Gold.."Gold:SADD:NUM"..msg.chat_id..msg.sender_id.user_id,1)
if tonumber(Redis:get(Gold.."Gold:SADD:NUM"..msg.chat_id..msg.sender_id.user_id)) >= 3 then
Redis:del(Gold.."Gold:SADD:NUM"..msg.chat_id..msg.sender_id.user_id)
Redis:del(Gold.."Gold:Game:Estimate"..msg.chat_id..msg.sender_id.user_id)
...
if Redis:get(Gold.."Gold:Game:Difference"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:Difference"..msg.chat_id) then 
Redis:del(Gold.."Gold:Game:Difference"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
end
if Redis:get(Gold.."Gold:Game:Example"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:Example"..msg.chat_id) then 
Redis:del(Gold.."Gold:Game:Example"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
...
if Redis:get(Gold.."gamebot:Set:Manager:rd"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(Gold.."gamebot:Set:Manager:rd"..msg.sender_id.user_id..":"..msg.chat_id,"true1uu")
Redis:sadd(Gold.."gamebot:List:Manager", text)
return send(msg.chat_id,msg.id,'\n⇜ تم حفظ السؤال')
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."gamebot:Set:Manager:rdd"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(Gold.."gamebot:Set:Manager:rdd"..msg.sender_id.user_id..":"..msg.chat_id,"true1uu")
Redis:srem(Gold.."gamebot:List:Manager", text)
return send(msg.chat_id,msg.id,'\n⇜ تم مسح السؤال')
end
end
if Redis:get(Gold.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'start' then
if msg.content.audio then  
Redis:set(Gold.."audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,msg.content.audio.audio.remote.id)  
Redis:sadd(Gold.."audio:Games:Bot",msg.content.audio.audio.remote.id)  
Redis:set(Gold.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,'started')
return send(msg.chat_id, msg.id,'⇜ ارسل الجواب الان ...')
end   
end
if Redis:get(Gold.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'started' then
local Id_audio = Redis:get(Gold.."audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
Redis:set(Gold..'Text:Games:audio'..Id_audio,text)
Redis:del(Gold.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return send(msg.chat_id, msg.id,'⇜ تم حفظ السؤال والجواب')
end
-----------------
if Redis:get(Gold..'Games:Set:Answer'..msg.chat_id) then
if text == ""..(Redis:get(Gold..'Games:Set:Answer'..msg.chat_id) or '66765$47').."" then 
Redis:del(Gold.."Games:Set:Answer"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)  
Redis:del(Gold.."Games:Set:Answer"..msg.chat_id)
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك ( 5 ) نقاط\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
...
if Redis:get(Gold.."Gold:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'startdel' then
if not Redis:sismember(Gold.."Gold:All:text:Games:Bot",text) then
send(msg_chat_id,msg_id,'⇜ لا يوجد صوت بهذا الاسم عام')
Redis:del(Gold.."Gold:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return false
end
Redis:del(Gold.."Gold:All:audio:Games"..text)
Redis:srem(Gold.."Gold:All:text:Games:Bot",text)  
Redis:del(Gold.."Gold:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⇜ تم مسح الصوت بنجاح')
return false
end
if Redis:get(Gold.."Gold:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'start' then
Redis:set(Gold..'Gold:All:Text:Games:audio'..msg.chat_id,text)
Redis:sadd(Gold.."Gold:All:text:Games:Bot",text)  
Redis:set(Gold.."Gold:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,'started')
send(msg_chat_id,msg_id,'⇜ ارسل الصوت ليتم حفظه باسم : '..text)
return false
end
if Redis:get(Gold.."Gold:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'started' then
if msg.content.audio then  
local nameaudio = Redis:get(Gold..'Gold:All:Text:Games:audio'..msg.chat_id)
Redis:set(Gold.."Gold:All:audio:Games"..nameaudio,msg.content.audio.audio.remote.id)  
Redis:del(Gold.."Gold:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⇜ تم حفظ الصوت باسم : '..nameaudio)
return false
end   
end
if text and not Redis:get(Gold..'lock_geamsAudio'..msg.chat_id) then
local nameaudio = Redis:get(Gold.."Gold:All:audio:Games"..text)
if nameaudio then
bot.sendAudio(msg_chat_id, msg.id,nameaudio , '', "md") 
end
end
if Redis:get(Gold.."Gold:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'startdel' then
if not Redis:sismember(Gold.."Gold:text:Games:Bot"..msg.chat_id,text) then
send(msg_chat_id,msg_id,'⇜ لا يوجد صوت بهذا الاسم في القروب')
Redis:del(Gold.."Gold:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return false
end
Redis:del(Gold.."Gold:audio:Games"..msg.chat_id..text)
Redis:srem(Gold.."Gold:text:Games:Bot"..msg.chat_id,text)  
Redis:del(Gold.."Gold:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⇜ تم مسح الصوت بنجاح')
return false
end
if Redis:get(Gold.."Gold:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'start' then
Redis:set(Gold..'Gold:Text:Games:audio'..msg.chat_id,text)
Redis:sadd(Gold.."Gold:text:Games:Bot"..msg.chat_id,text)  
Redis:set(Gold.."Gold:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,'started')
send(msg_chat_id,msg_id,'⇜ ارسل الصوت ليتم حفضه باسم : '..text)
return false
end
if Redis:get(Gold.."Gold:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'started' then
if msg.content.audio then  
local nameaudio = Redis:get(Gold..'Gold:Text:Games:audio'..msg.chat_id)
Redis:set(Gold.."Gold:audio:Games"..msg.chat_id..nameaudio,msg.content.audio.audio.remote.id)  
Redis:del(Gold.."Gold:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⇜ تم حفظ الصوت باسم : '..nameaudio)
return false
end   
end
if text and not Redis:get(Gold..'lock_geamsAudio1'..msg.chat_id) then
local nameaudio = Redis:get(Gold.."Gold:audio:Games"..msg.chat_id..text)
if nameaudio then
bot.sendAudio(msg_chat_id, msg.id,nameaudio , '', "md") 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "truedel" then
Redis:set(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"truefguigf1")
Redis:del(Gold.."gamebot:newqus"..msg.chat_id,text)
Redis:srem(Gold.."gamebot:new1", text)
return send(msg_chat_id,msg_id, '\nتم مسح السؤال') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true1")
Redis:set(Gold.."gamebot:newqus"..msg.chat_id,text)
Redis:sadd(Gold.."gamebot:new1", text)
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ السؤال \n⇜ ارسل الجواب الاول') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true1" then
local quschen = Redis:get(Gold.."gamebot:newqus"..msg.chat_id)
Redis:set(Gold.."gamebot:newqus:as1"..quschen,text)
Redis:set(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true2")
return send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الثاني') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true2" then
local quschen = Redis:get(Gold.."gamebot:newqus"..msg.chat_id)
Redis:set(Gold.."gamebot:newqus:as2"..quschen,text)
Redis:set(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true3")
return send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الثالث') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true3" then
local quschen = Redis:get(Gold.."gamebot:newqus"..msg.chat_id)
Redis:set(Gold.."gamebot:newqus:as3"..quschen,text)
Redis:set(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true4")
return send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الرابع') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true4" then
local quschen = Redis:get(Gold.."gamebot:newqus"..msg.chat_id)
Redis:set(Gold.."gamebot:newqus:as0"..quschen,text)
Redis:set(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true44")
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ الاجوبة \n⇜ ارسل الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true44" then
local quschen = Redis:get(Gold.."gamebot:newqus"..msg.chat_id)
Redis:set(Gold.."gamebot:newqus:as4"..quschen,text)
Redis:set(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true186")
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "truedel" then
send(msg_chat_id,msg_id, '\n⇜ تم مسح الغز ')
Redis:set(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"truefguigf1")
Redis:del(Gold.."lkz:gamebot:newqus"..msg.chat_id,text)
Redis:srem(Gold.."lkz:gamebot:new1", text)
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
send(msg_chat_id,msg_id, '\n⇜ تم حفظ اللغز \n⇜ ارسل الجواب الاول')
Redis:set(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true1")
Redis:set(Gold.."lkz:gamebot:newqus"..msg.chat_id,text)
Redis:sadd(Gold.."lkz:gamebot:new1", text)
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true1" then
send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الثاني')
local quschen = Redis:get(Gold.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(Gold.."lkz:gamebot:newqus:as1"..quschen,text)
Redis:set(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true2")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true2" then
send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الثالث')
local quschen = Redis:get(Gold.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(Gold.."lkz:gamebot:newqus:as2"..quschen,text)
Redis:set(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true3")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true3" then
send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الصحيح')
local quschen = Redis:get(Gold.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(Gold.."lkz:gamebot:newqus:as3"..quschen,text)
Redis:set(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true44")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true44" then
send(msg_chat_id,msg_id, '\n⇜ تم حفظ الجواب الصحيح')
local quschen = Redis:get(Gold.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(Gold.."lkz:gamebot:newqus:as4"..quschen,text)
Redis:set(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true186")
return false 
end
end
if Redis:get(Gold..":"..msg.sender_id.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(Gold..":"..msg.sender_id.user_id..":lov_Bots"..msg.chat_id)
end
if text and Redis:get(Gold..":"..msg.sender_id.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '*⇜ نسبه الكره : '..text..' '..sendnum..'%*'
send(msg_chat_id,msg_id,tttttt,"md",true)  
Redis:del(Gold..":"..msg.sender_id.user_id..":krh_Bots"..msg.chat_id)
end
if text and Redis:get(Gold..":"..msg.sender_id.user_id..":frind_Bots"..msg.chat_id) == "sendfrind" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","😎 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '*⇜ نسبه الصداقة '..text..' '..sendnum..'%*'
send(msg_chat_id,msg_id,tttttt,"md",true)  
Redis:del(Gold..":"..msg.sender_id.user_id..":frind_Bots"..msg.chat_id)
end
if Redis:get(Gold.."Gold:Game:Arbieq"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:Arbieq"..msg.chat_id) then 
Redis:del(Gold.."Gold:Game:Arbieq"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
...
---------------------- عقـــاب ----------------------
if Redis:get(Gold.."Start_Ahkamm"..msg.chat_id) then
if text == "انا" then
if Redis:sismember(Gold..'List_Ahkamm'..msg.chat_id,msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(Gold..'members_Ahkamm'..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Gold..'List_Ahkamm'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Gold.."Witting_StartGamehh"..msg.chat_id,1400,true)
...
---------------------- احكـــام ----------------------
if text == "انا" and Redis:get(Gold.."Start_Ahkkam"..msg.chat_id) then
if Redis:sismember(Gold..'List_Ahkkam'..msg.chat_id,msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(Gold..'List_Ahkkam'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Gold.."Witting_StartGameh"..msg.chat_id,1400,true)
local list = Redis:smembers(Gold..'List_Ahkkam'..msg.chat_id) 
if #list == 2 then
...
---------------------- كرســـي الاعتـــراف ----------------------
if text == "انا" and Redis:get(Gold.."Start_Koorsi"..msg.chat_id) then
if Redis:sismember(Gold..'List_Koorsi'..msg.chat_id,msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
...
Redis:sadd(Gold..'List_Koorsi'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Gold.."Witting_StartGameek"..msg.chat_id,1400,true)
local list = Redis:smembers(Gold..'List_Koorsi'..msg.chat_id) 
if #list == 2 then
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')'
local zzllzz = '⇜ عدد الاعبين : '..#list..' \n⇜ انضم للعبة \n'..Teext
...
-----------------
if Redis:get(Gold.."Gold:Game:Arbieq:aslame"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:Arbieq:aslame"..msg.chat_id) then 
Redis:del(Gold.."Gold:Game:Arbieq:aslame"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
end
if Redis:get(Gold.."Gold:Game:Arbieq:aslamek"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:Arbieq:aslamek"..msg.chat_id) then 
Redis:del(Gold.."Gold:Game:Arbieq:aslamek"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
end
if Redis:get(Gold.."Gold:Game:Monotonousss"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:Monotonousss"..msg.chat_id) then 
Redis:del(Gold.."Gold:Game:Monotonousss"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
...
-----------------
if Redis:get(Gold.."mshaher"..msg.chat_id) then
if text == Redis:get(Gold.."mshaher"..msg.chat_id) then
Redis:del(Gold.."mshaher"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true)  
end
end 
if Redis:get(Gold.."mshaherr"..msg.chat_id) then
if text == Redis:get(Gold.."mshaherr"..msg.chat_id) then
Redis:del(Gold.."mshaherr"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true)  
end
end
if Redis:get(Gold.."mshaherrr"..msg.chat_id) then
if text == Redis:get(Gold.."mshaherrr"..msg.chat_id) then
Redis:del(Gold.."mshaherrr"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true)  
end
end  
if Redis:get(Gold.."photohzr"..msg.chat_id) then
if text == Redis:get(Gold.."photohzr"..msg.chat_id) then
Redis:del(Gold.."photohzr"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true)  
end
...
-----------------
if Redis:get(Gold.."Start_rhan"..msg.chat_id) then
...
if Redis:sismember(Gold..'List_rhan'..msg.chat_id,msg.sender_id.user_id) then
...
Redis:setex(Gold.."Witting_Startrhan"..msg.chat_id,1400,true)
benrahan = Redis:get(Gold.."allrhan"..msg.chat_id..12345) or 0
rehan = tonumber(benrahan) + tonumber(coniss)
Redis:set(Gold.."allrhan"..msg.chat_id..12345 , rehan)
...
if Redis:get(Gold.."Gold:Status:Games:malk"..msg.chat_id) then
return false 
end
if not Redis:get(Gold.."Gold:Status:Games"..msg.chat_id) then
return false
end
local list = {"3","5","-3","-5","="}
RtList = list[math.random(#list)]
if RtList == "3" then
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,3)
StatusRt = "الف مبروك حظك حلو ربحت 3 نقاط"
elseif RtList == "5" then
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)
StatusRt = "الف مبروك حظك حلو ربحت 5 نقاط"
elseif RtList == "-3" then
Redis:decrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,3)  
StatusRt = "للاسف حظك زفت خسرت 3 نقاط"
elseif RtList == "-5" then
Redis:decrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)  
...
Redis:set(Gold.."Gold:Game:Arbieq"..msg.chat_id,name)
return false
end
...
Redis:set(Gold.."Gold:Game:Arbieq:aslame"..msg.chat_id,name)
return false
end
if text == "اية" then
if Redis:get(Gold.."Gold:Status:Games:malk"..msg.chat_id) then
...
Redis:set(Gold.."Gold:Game:Arbieq:aslamek"..msg.chat_id,name)
return false
end
...
Redis:set(Gold.."Gold:Game:Monotonousss"..msg.chat_id,name)
return false
end
if text == "حجره" then
if Redis:sismember(Gold.."Gold:Text:Cmd:Lock"..msg_chat_id,text) then
...
local Bot_Name = (Redis:get(Gold.."Gold:Name:Bot") or "زلزال")
if not Redis:get(Gold.."Gold:Status:repleall") then
if text == 'صباح الخير' or text == 'صباحو' or text =='صباح النور' then
if Redis:get(Gold.."replayallbot"..msg.chat_id) then
local NamecBots = {
'صباح الورد',
'صباح النور',
}
...
if text== "الابراج"  or text== "ابراج"  and Redis:get(Gold..'replayallbot'..msg.chat_id) then
return send(msg.chat_id,msg.id,"ٰ⇜ اكتب : برج + اسم برجك ")
end
if text== "تحويل الصيغ" and Redis:get(Gold..'replayallbot'..msg.chat_id) then
...
Redis:set(Gold.."gamebot:Set:Manager:rd"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(Gold.."gamebot:Set:Manager:rdd"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
if Redis:get(Gold.."Gold:Status:Games"..msg.chat_id) then 
local list = {
...
Redis:sadd(Gold.."Black:listBan:",Chatid)
...
Redis:srem(Gold.."Black:listBan:",Chatid)
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Gold..'Gold:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Gold..'Gold:Chat:Channel:Join'..msg.chat_id)}, },}}
...
Redis:del(Gold..'rolet:list'..msg.chat_id) 
...
Redis:del(Gold..'loce:list'..msg.chat_id) 
send(msg_chat_id,msg_id,xxffxx,"md",false, false, false, false, reply_markup)
end
end
...
Redis:set(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(Gold.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"⇜ ارسل السؤال الان ")
end
...
local list = Redis:smembers(Gold.."gamebot:new1")
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(Gold.."Gold:Game:alam"..msg.chat_id,name)
...
Redis:set(Gold.."Gold:Game:ausm"..msg.chat_id,name)
return false
end
end
if Redis:get(Gold.."Gold:Game:klmaa"..msg.chat_id) then
if text == Redis:get(Gold.."Gold:Game:klmaa"..msg.chat_id) then
Redis:del(Gold.."Gold:Game:klmaa"..msg.chat_id)
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
...
Redis:set(Gold.."Gold:Game:klmaa"..msg.chat_id,name)
return false
end
end
-----------------
...
Redis:del(Gold..'List_Ahkamm'..msg.chat_id)
Redis:del(Gold..'members_Ahkamm'..msg.chat_id) 
Redis:set(Gold.."raeahkamm"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Gold..'List_Ahkamm'..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Gold..'members_Ahkamm'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Gold.."Start_Ahkamm"..msg.chat_id,3600,true)
...
local list = Redis:smembers(Gold..'List_Ahkamm'..msg.chat_id) 
...
if text == 'نعم' and Redis:get(Gold.."Witting_StartGamehh"..msg.chat_id) then
rarahkam = Redis:get(Gold.."raeahkamm"..msg.chat_id)
...
Redis:sadd(Gold.."kk_Akab"..msg.chat_id,UserId_Info.id)
Redis:srem(Gold..'members_Ahkamm'..msg_chat_id,UserId_Info.id) 
local GetLike = Redis:incrby(Gold.."Num:Add:Akab"..msg.chat_id..UserId_Info.id, 1) 
Redis:hset(Gold..':GroupUserCountAkab:'..msg.chat_id,UserId_Info.id,GetLike)
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(Gold..':GroupAkabNameUser:'..msg.chat_id,UserId_Info.id,NameLUser)
Redis:del(Gold..'raeahkamm'..msg.chat_id) 
Redis:del(Gold..'List_Ahkamm'..msg.chat_id) 
Redis:del(Gold.."Witting_StartGamehh"..msg.chat_id)
Redis:del(Gold.."Start_Ahkamm"..msg.chat_id)
katu = {
...
Redis:del(Gold..'List_Ahkkam'..msg.chat_id)
Redis:set(Gold.."raeahkkam"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Gold..'List_Ahkkam'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Gold.."Start_Ahkkam"..msg.chat_id,3600,true)
...
local Quuiz = Redis:get(Gold.."Quiz:Add:Koorsy"..msg.chat_id) or 0
...
Redis:del(Gold..'List_Koorsi'..msg.chat_id)
Redis:del(Gold.."Quiz:Add:Koorsy"..msg.chat_id)
Redis:set(Gold.."raekoorsi"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Gold..'List_Koorsi'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Gold.."Start_Koorsi"..msg.chat_id,3600,true)
bot.sendText(msg_chat_id,msg_id,zzllzz,"md",false, false, false, false, reply_markup)
end
----------------------------------------
...
local Qiuiz = Redis:get(Gold.."Quiz:Add:Saraha"..msg.chat_id) or 0
...
Redis:del(Gold..'List_Saraha'..msg.chat_id)
Redis:del(Gold.."Quiz:Add:Saraha"..msg.chat_id)
Redis:set(Gold.."raesaraha"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Gold..'List_Saraha'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Gold.."Start_Saraha"..msg.chat_id,3600,true)
bot.sendText(msg_chat_id,msg_id,zzllzz,"md",false, false, false, false, reply_markup)
end
----------------------------------
...
if not Redis:get(Gold.."Status:Aktmooh"..msg.chat_id) then
...
elseif Redis:sismember(Gold.."Gold:DevelopersQ:Groups",ban.id) then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم المطورين*',"md",true) 
elseif Redis:sismember(Gold.."Gold:MevelopersQ:Groups",ban.id) then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم المطورين*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Developers:Groups",ban.id) then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم المطورين*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Mevelopers:Groups",ban.id) then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم المطورين*',"md",true) 
elseif Redis:sismember(Gold.."Gold:MalekAsase:Group"..msg_chat_id, ban.id) then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم المالك الاساسي*',"md",true)
elseif Redis:sismember(Gold.."Gold:MalemAsase:Group"..msg_chat_id, ban.id) then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم المالك الاساسي*',"md",true) 
elseif Redis:sismember(Gold.."Gold:TheBasicsQ:Group"..msg_chat_id, ban.id) then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم المالك*',"md",true) 
elseif Redis:sismember(Gold.."Gold:TheMasicsQ:Group"..msg_chat_id, ban.id) then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم المالك*',"md",true) 
elseif Redis:sismember(Gold.."Gold:TheBasics:Group"..msg_chat_id, ban.id) then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم المنشئ الاساسي*',"md",true) 
elseif Redis:sismember(Gold.."Gold:TheMasics:Group"..msg_chat_id, ban.id) then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم المنشئ الاساسي*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Originators:Group"..msg_chat_id, ban.id) then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم المنشئ*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Origimators:Group"..msg_chat_id, ban.id) then
return bot.sendText(msg_chat_id,msg_id,'*⇜ هـييهه .. مايمديك تكتم المنشئ*',"md",true) 
end
...
Redis:set(Gold.."Ak_Tmooh"..msg.chat_id,Message_Reply.sender_id.user_id)
Redis:del(Gold..'List_Aktooh'..msg.chat_id)
Redis:set(Gold.."raeaktooh"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Gold..'List_Aktooh'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Gold.."Start_Aktmooh"..msg.chat_id,3600,true)
bot.sendText(msg_chat_id,msg_id,zzllzz,"md",false, false, false, false, reply_markup)
end
-----------------
...
Redis:set(Gold.."makal:bots:set"..msg.sender_id.user_id..":"..msg.chat_id,true)
return send(msg_chat_id,msg_id,"⇜ ارسل السؤال الان ")
end
...
Redis:set(Gold.."makal:bots:del"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:del(Gold.."makal:bots")
return send(msg_chat_id,msg_id,"⇜ تم مسح الجمل")
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."makal:bots:del"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(Gold.."makal:bots:del"..msg.sender_id.user_id..":"..msg.chat_id,"true1uu")
Redis:srem(Gold.."makal:bots", text)
return send(msg_chat_id,msg_id, '\n⇜ تم مسح السؤال')
end
end
if text and text:match("^(.*)$") then
if Redis:get(Gold.."makal:bots:set"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(Gold.."makal:bots:set"..msg.sender_id.user_id..":"..msg.chat_id,"true1uu")
Redis:sadd(Gold.."makal:bots", text)
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ السؤال ')
end
end
if text == 'جمل' then
...
Redis:set(Gold.."makal:bots:qus"..msg.chat_id,quschen1)
Redis:setex(Gold.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id, 60, true) 
end
end
end
if text == ""..(Redis:get(Gold.."makal:bots:qus"..msg.chat_id) or '').."" then
local timemkall = Redis:ttl(Gold.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
...
Redis:del(Gold.."makal:bots:qus"..msg.sender_id.user_id..":"..msg.chat_id)
Redis:del(Gold.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
end
if text =="صراحه" then
if Redis:sismember(Gold.."Gold:Text:Cmd:Lock"..msg_chat_id,text) then
if Locks_Status(msg.sender_id.user_id,msg,text) ~= "noon" then
...
if not Redis:get(Gold..'lock_geams'..msg.chat_id) then
local list = Redis:smembers(Gold.."gamebot:new1")
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(Gold.."gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(Gold.."gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(Gold.."gamebot:newqus:as3"..quschen)
local ansar0 = Redis:get(Gold.."gamebot:newqus:as0"..quschen)
local ansar4 = Redis:get(Gold.."gamebot:newqus:as4"..quschen)
...
Redis:set(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(Gold.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"⇜ ارسل اللغز الان ")
end
...
local list = Redis:smembers(Gold.."lkz:gamebot:new1")
t = "⇜ الالغاز : \n"
for k,v in pairs(list) do
t = t..""..k.."- "..v.."\n"
end
...
Redis:del(Gold.."lkz:gamebot:new1")
...
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(Gold.."lkz:gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(Gold.."lkz:gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(Gold.."lkz:gamebot:newqus:as3"..quschen)
local ansar4 = Redis:get(Gold.."lkz:gamebot:newqus:as4"..quschen)
if ansar1 == ansar4 then
tt = 'ansar1'
elseif ansar2 == ansar4 then
tt = 'ansar2'
...
local list = Redis:smembers(Gold.."gamebot:List:Manager")
t = "⇜ الاسئله المضافه : \n"
for k,v in pairs(list) do
t = t..""..k.."- (["..v.."])\n"
end
...
Redis:del(Gold.."gamebot:List:Manager")
...
local numtsh = Redis:scard(Gold..'Gold:mrtee'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي هطوف" )
end
Redis:del(Gold..'Gold:mrtee'..msg.chat_id)
...
if Redis:get(Gold.."trfeh"..msg.chat_id) then
return send(msg_chat_id,msg_id,"⇜ التسليـه معطلـه من قبل المـدراء ؟!","md",true)
end 
Redis:set(Gold..":"..msg.sender_id.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
Redis:set(Gold..":"..msg.sender_id.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
...
Redis:set(Gold..":"..msg.sender_id.user_id..":frind_Bots"..msg.chat_id,"sendfrind")
hggg = '*⇜ الان ارسل اسمك واسم الشخص الثاني \n⇜ مثـال :\nاحمد ومحمد* '
send(msg_chat_id,msg_id,hggg,"md",true)  
return false
end
...
elseif Redis:sismember(Gold.."Gold:DevelopersQ:Groups",Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*⇜ هييه مايمديك تستخدم الامر على المطور الثانوي ياورع !!*',"md",true) 
elseif Redis:sismember(Gold.."Gold:MevelopersQ:Groups",Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*⇜ هييه مايمديك تستخدم الامر على المطوره الثانويه ياورع !!*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Developers:Groups",Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*⇜ هييه مايمديك تستخدم الامر على المطور ياورع !!*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Mevelopers:Groups",Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*⇜ هييه مايمديك تستخدم الامر على المطوره ياورع !!*',"md",true) 
elseif Redis:sismember(Gold.."Gold:MalekAsase:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*⇜ هييه مايمديك تستخدم الامر على المالك الاساسي ياورع !!*',"md",true)
elseif Redis:sismember(Gold.."Gold:MalemAsase:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*⇜ هييه مايمديك تستخدم الامر على المالكه الاساسيه ياورع !!*',"md",true) 
elseif Redis:sismember(Gold.."Gold:TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*⇜ هييه مايمديك تستخدم الامر على المالك ياورع !!*',"md",true) 
elseif Redis:sismember(Gold.."Gold:TheMasicsQ:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*⇜ هييه مايمديك تستخدم الامر على المالكه ياورع !!*',"md",true) 
elseif Redis:sismember(Gold.."Gold:TheBasics:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*⇜ هييه مايمديك تستخدم الامر على المنشئ الاساسي ياورع !!*',"md",true) 
elseif Redis:sismember(Gold.."Gold:TheMasics:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
...
-----------------
if text== "رفع هطف" and msg.reply_to_message_id and not Redis:get(Gold.."trfeh"..msg.chat_id) then
if Redis:sismember(Gold.."Gold:Text:Cmd:Lock"..msg_chat_id,text) then
if Locks_Status(msg.sender_id.user_id,msg,text) ~= "noon" then
return send(msg_chat_id,msg_id,Locks_Status(msg.sender_id.user_id,msg,text),"md",true)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(Gold.."Gold:mrtee"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته هطف 🧱\n✓")
elseif text== "تنزيل هطف"  and msg.reply_to_message_id and not Redis:get(Gold.."trfeh"..msg.chat_id) then
if Redis:sismember(Gold.."Gold:Text:Cmd:Lock"..msg_chat_id,text) then
if Locks_Status(msg.sender_id.user_id,msg,text) ~= "noon" then
return send(msg_chat_id,msg_id,Locks_Status(msg.sender_id.user_id,msg,text),"md",true)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(Gold.."Gold:mrtee"..msg.chat_id, Message_Reply.sender_id.user_id)
...
local list = Redis:smembers(Gold.."Gold:mrtee"..msg.chat_id)
...
if not Redis:get(Gold.."Gold:Alzwag:Chat"..msg_chat_id) then
...
if tonumber(member_id) == tonumber(msg.sender_id.user_id) or tonumber(member_id) == tonumber(Gold) or bot.getUser(member_id).type.luatele == "userTypeBot" or Redis:get(Gold..msg_chat_id..member_id.."mtzwga:") then 
return send(msg_chat_id,msg_id,"⇜ اسف ياحلو مو وقت زواج الحين","md")
end
if Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
    local zwg_id =  Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(Gold..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")) == tonumber(msg.sender_id.user_id) or tonumber(Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:")) == tonumber(Message_Reply.sender_id.user_id) then
...
elseif Redis:get(Gold..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:") then
local zwg_id =  Redis:get(Gold..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")
local zwg_info = bot.getUser(zwg_id)
return send(msg_chat_id,msg_id,"⇜ وينك ياوحش\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\n⇜ يبون يتزوجو زوجتك ","md")
elseif Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
  local zwg_id =  Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
  local zwg_info = bot.getUser(zwg_id)
  return send(msg_chat_id,msg_id,"⇜ الحين اناديها انتظر\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\n⇜ يبي يتزوج عليك هههه","md")
elseif not Redis:get(Gold..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")  then
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
local zwga_id = Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
...
elseif not Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
...
elseif tonumber(Redis:get(Gold..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")) ~= tonumber(msg.sender_id.user_id) or tonumber(Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:")) ~= tonumber(Message_Reply.sender_id.user_id) then
  return send(msg_chat_id,msg_id,"⇜ هييه مايمديك تطلقها لان مو زوجتك\n✓","md")
elseif tonumber(Redis:get(Gold..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")) == tonumber(msg.sender_id.user_id) or tonumber(Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:")) == tonumber(Message_Reply.sender_id.user_id) then
    Redis:del(Gold..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")
    Redis:del(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
...
return send(msg_chat_id,msg_id,Locks_Status(msg.sender_id.user_id,msg,text),"md",true)
  ...
  if not Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then 
  return send(msg_chat_id,msg_id,"⇜ هييه انت/ـي مو متزوج/ـه\n✓","md")
  elseif Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
    local zwg_id = Redis:get(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
    local zwg_name = bot.getUser(zwg_id).first_name
    Redis:del(Gold..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
    Redis:del(Gold..msg_chat_id..zwg_id.."mtzwga:")
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(Gold.."mshaher"..msg.chat_id,name)
...
Redis:set(Gold.."mshaherr"..msg.chat_id,name)
...
Redis:set(Gold.."mshaherrr"..msg.chat_id,name)
...
name = KlamSpeeddd[math.random(#KlamSpeeddd)]
Redis:set(Gold.."photohzr"..msg.chat_id,name)
...
Redis:setex(Gold.."Status:aktbassend"..msg.chat_id,120,true) 
return send(msg_chat_id,msg_id,'\n⇜ ارسل لي الاقتباس\n- يسمح لك :\n( ملصق + صورة + نص + فيديو + صوت )',"md",true)  
end
if Redis:get(Gold..'Status:aktbassend'..msg.chat_id) then
Redis:del(Gold..'Status:aktbassend'..msg.chat_id)
Redis:del(Gold..'Status:aktbasrdstic'..msg.chat_id)
Redis:del(Gold..'Status:aktbasrdtext'..msg.chat_id)
Redis:del(Gold..'Status:aktbasrdaudio'..msg.chat_id)
Redis:del(Gold..'Status:aktbasrdanim'..msg.chat_id)
Redis:del(Gold..'Status:aktbasrdvid'..msg.chat_id)
Redis:del(Gold..'Status:aktbasrdphoto'..msg.chat_id)
if msg.content.sticker then   
Redis:set(Gold.."Status:aktbasrdstic"..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Gold.."Status:aktbasrdtext"..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(Gold.."Status:aktbasrdaudio"..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.animation then
Redis:set(Gold.."Status:aktbasrdanim"..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video then
Redis:set(Gold.."Status:aktbasrdvid"..msg_chat_id, msg.content.video.video.remote.id)  
end
...
Redis:set(Gold.."Status:aktbasrdphoto"..msg_chat_id, idPhoto)  
end
...
Redis:del(Gold..'Status:Reply'..msg.chat_id)
Redis:set(Gold.."Status:aktbas"..msg.chat_id,true) 
...
Redis:set(Gold..'Status:Reply'..msg.chat_id,true)
Redis:del(Gold.."Status:aktbas"..msg.chat_id) 
send(msg.chat_id,msg.id,"⇜ ابشر عطلت الاقتباسات ","md",true)
end
-----------------
if Redis:get(Gold..'Status:aktbas'..msg.chat_id) == 'true' then
...
if Redis:get(Gold..'Status:aktbasrdstic'..msg.chat_id) then
return bot.sendSticker(msg.chat_id, 0, Redis:get(Gold..'Status:aktbasrdstic'..msg.chat_id))
elseif Redis:get(Gold..'Status:aktbasrdtext'..msg.chat_id) then
return send(msg.chat_id,0,Redis:get(Gold..'Status:aktbasrdtext'..msg.chat_id),"md",true)
elseif Redis:get(Gold..'Status:aktbasrdaudio'..msg.chat_id) then
return bot.sendAudio(msg.chat_id, 0, Redis:get(Gold..'Status:aktbasrdaudio'..msg.chat_id), '', "md") 
elseif Redis:get(Gold..'Status:aktbasrdanim'..msg.chat_id) then
return bot.sendAnimation(msg.chat_id,0, Redis:get(Gold..'Status:aktbasrdanim'..msg.chat_id), '', 'md')
elseif Redis:get(Gold..'Status:aktbasrdphoto'..msg.chat_id) then
return bot.sendPhoto(msg.chat_id, 0, Redis:get(Gold..'Status:aktbasrdphoto'..msg.chat_id),'')
elseif Redis:get(Gold..'Status:aktbasrdvid'..msg.chat_id) then
return bot.sendVideo(msg.chat_id, 0, Redis:get(Gold..'Status:aktbasrdvid'..msg.chat_id), '', "md")
else
...
if not Redis:get(Gold.."knele"..msg.chat_id) then
...
elseif Redis:sismember(Gold.."Gold:Originators:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*- هـذا المنشـئ حبقلبـي 🌷🌚*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Origimators:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*- هـاي المنشـئـه حبيبـة قلبـي 🌷🌚*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Managers:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*- هـذا المـديـر حبعمـري 💕😻*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Mamagers:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*- هـاي المـديـره حبعمـري 💕😻*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Addictive:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*- هـذا الادمـن الصـاك حبيبـي 💋😻*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Mddictive:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*- هـاي الادمـونه الصـاكـه حيـاتي 💋😻*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Distinguished:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,'*- هـذا المميـز حبـي 🤩*',"md",true) 
elseif Redis:sismember(Gold.."Gold:Mistinguished:Group"..msg_chat_id, Message_Reply.sender_id.user_id) then
...
Redis:set(Gold.."Gold:Game:Smile"..msg.chat_id,SM)
...
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(Gold.."Gold:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Gold.."Gold:Game:Riddles"..msg.chat_id,name)
...
if Redis:get(Gold.."Gold:Status:Games"..msg.chat_id) then
Redis:del(Gold.."Gold:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Gold.."Gold:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(Gold.."Gold:Status:Games"..msg.chat_id) then
Redis:del(Gold.."Gold:Set:Aks"..msg.chat_id)
...
name = katu[math.random(#katu)]
Redis:set(Gold.."Gold:Game:Reflection"..msg.chat_id,name)
...
Redis:set(Gold.."Gold:Game:Estimate"..msg.chat_id..msg.sender_id.user_id,Num)  
...
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'النيل') 
elseif SENDTEXT:find('14') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'14') 
elseif SENDTEXT:find('الفم') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'الفم') 
elseif SENDTEXT:find('11') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'11') 
elseif SENDTEXT:find('30') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'30') 
elseif SENDTEXT:find('بوتين') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'بوتين') 
elseif SENDTEXT:find('ستيف جوبر') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'ستيف جوبر') 
elseif SENDTEXT:find('باريس') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'باريس') 
elseif SENDTEXT:find('10') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'10') 
elseif SENDTEXT:find('النمل') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'النمل') 
elseif SENDTEXT:find('حرف الواو') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'حرف الواو') 
elseif SENDTEXT:find('الشعر') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'الشعر') 
elseif SENDTEXT:find('ابراهيم') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'ابراهيم') 
elseif SENDTEXT:find('سحاب') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'سحاب') 
elseif SENDTEXT:find('الاسم') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'الاسم') 
elseif SENDTEXT:find('ذهب') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'ذهب') 
elseif SENDTEXT:find('حرف الام') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'حرف الام') 
elseif SENDTEXT:find('العزائم') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'العزائم') 
elseif SENDTEXT:find('انسات') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'انسات') 
elseif SENDTEXT:find('المنجنيق') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'المنجنيق') 
elseif SENDTEXT:find('اسيا') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'اسيا') 
elseif SENDTEXT:find('الاسد') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'الاسد') 
elseif SENDTEXT:find('6') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'6') 
elseif SENDTEXT:find('مهر') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'مهر') 
elseif SENDTEXT:find('الدلفين') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'الدلفين') 
elseif SENDTEXT:find('اوروبا') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'اوروبا') 
elseif SENDTEXT:find('الزئبق') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'الزئبق') 
elseif SENDTEXT:find('لندن') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'لندن') 
elseif SENDTEXT:find('الانسان') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'الانسان') 
elseif SENDTEXT:find('طوكيو') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'طوكيو') 
elseif SENDTEXT:find('خديجه') then
Redis:set(Gold.."GAME:CHER"..msg.chat_id,'خديجه') 
end
send(msg.chat_id,msg.id,SENDTEXT)
return false  
end
end
if Redis:get(Gold.."GAME:CHER"..msg.chat_id) and (text == Redis:get(Gold.."GAME:CHER"..msg.chat_id)) then  
if text then
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)
Redis:del(Gold.."GAME:CHER"..msg.chat_id)
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true)
...
print(name)
Redis:set(Gold..'bot:bkbk6'..msg.chat_id,name)
...
Redis:set(Gold..'bot:bkbk7'..msg.chat_id,name)
...
if Redis:get(Gold.."Gold:Status:Games"..msg.chat_id) then
Redis:del(Gold..":Number_Add:"..msg.chat_id..msg.sender_id.user_id) 
Redis:del(Gold..':List_Rolet:'..msg.chat_id)  
Redis:setex(Gold..":Start_Rolet:"..msg.chat_id..msg.sender_id.user_id,3600,true)  
return send(msg_chat_id,msg_id, '⇜ حسناً لنلعب , ارسل عدد اللاعبين للروليت .',"md")
end
end
if text == 'نعم' and Redis:get(Gold..":Witting_StartGame:"..msg.chat_id..msg.sender_id.user_id) then
local list = Redis:smembers(Gold..':List_Rolet:'..msg.chat_id) 
if #list == 1 then 
...
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 5)  
Redis:del(Gold..':List_Rolet:'..msg.chat_id) 
Redis:del(Gold..":Witting_StartGame:"..msg.chat_id..msg.sender_id.user_id)
...
if text and text:match("^(%d+)$") and Redis:get(Gold..":Start_Rolet:"..msg.chat_id..msg.sender_id.user_id) then
if text == "1" then
Text = "⇜ لا استطيع بدء اللعبة بلاعب واحد فقط\n"
else
Redis:set(Gold..":Number_Add:"..msg.chat_id..msg.sender_id.user_id,text)  
Text = '⇜ يرجى ارسال يوزرات اللاعبين \n⇜ الفائز يحصل على ( 5 ) نقاط\n⇜ عدد الاعبين المطلوبين ( '..text..' ) لاعب \n  ✓'
end
Redis:del(Gold..":Start_Rolet:"..msg.chat_id..msg.sender_id.user_id)  
return send(msg_chat_id,msg_id,Text)    
end
if text and text:match('^(@[%a%d_]+)$') and Redis:get(Gold..":Number_Add:"..msg.chat_id..msg.sender_id.user_id) then    --// استقبال الاسماء
if Redis:sismember(Gold..':List_Rolet:'..msg.chat_id,text) then
return send(msg_chat_id,msg_id,'⇜  اليوزر ['..text..'] موجود قبل' ,"md")
end
Redis:sadd(Gold..':List_Rolet:'..msg.chat_id,text)
local CountAdd = Redis:get(Gold..":Number_Add:"..msg.chat_id..msg.sender_id.user_id)
local CountAll = Redis:scard(Gold..':List_Rolet:'..msg.chat_id)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
Redis:del(Gold..":Number_Add:"..msg.chat_id..msg.sender_id.user_id) 
Redis:setex(Gold..":Witting_StartGame:"..msg.chat_id..msg.sender_id.user_id,1400,true)  
...
if text == ''..(Redis:get(Gold..'bot:bkbk6'..msg.chat_id) or 'لفاتع')..'' then
Redis:del(Gold..'bot:bkbk6'..msg.chat_id)  
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end 
if text == ''..(Redis:get(Gold..'bot:bkbk7'..msg.chat_id) or 'لفاتع')..'' then
Redis:del(Gold..'bot:bkbk7'..msg.chat_id)  
Redis:incrby(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)
local Num = Redis:get(Gold.."Gold:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✓","md",true) 
end
...
Redis:set(Gold.."Gold:Game:Example"..msg.chat_id,name)
...
if Redis:get(Gold.."hzergametime"..msg.chat_id) then
local time = ctime(Redis:ttl(Gold.."hzergametime"..msg.chat_id))
return send(msg.chat_id,msg.id,"⇜ في لعبة حزر قبل\n⇜ تنتهي بعد "..time.." \n✓","md",true)
end
Redis:set(Gold.."hazrgroupid"..msg.sender_id.user_id, msg_chat_id)
Redis:set(Gold.."hazrmalek"..msg_chat_id, msg.sender_id.user_id)
Redis:setex(Gold.."hzergametime"..msg.chat_id,300,true)
Redis:del(Gold.."hazranswer"..msg.chat_id)
Redis:del(Gold.."hazrqustion"..msg.chat_id)
Redis:del(Gold.."listhzerid"..msg.chat_id)
hazrwinerid = Redis:get(Gold.."hazrwinerid"..msg.chat_id) or 6642636501
...
Redis:set(Gold.."hazrlock"..msg_chat_id, boby)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(Gold.."hazranswer"..msg.chat_id) then
if text == Redis:get(Gold.."hazranswer"..msg.chat_id) and Redis:sismember(Gold.."listhzerid"..msg.chat_id, msg.sender_id.user_id) then
if tonumber(Redis:get(Gold.."hazrmalek"..msg_chat_id)) == msg.sender_id.user_id then
return bot.deleteMessages(msg.chat_id,{[1]= msg_id})
end
Redis:del(Gold.."hazranswer"..msg.chat_id)
Redis:del(Gold.."hazrqustion"..msg.chat_id)
Redis:del(Gold.."hazrmalek"..msg.chat_id)
Redis:del(Gold.."hazrlock"..msg.chat_id)
Redis:set(Gold.."hazrwinerid"..msg.chat_id, msg.sender_id.user_id)
local starttime = Redis:get(Gold..'Zilzal:Game:Time'..msg.chat_id) or 0
...
if not Redis:get(Gold.."Gold:Althnaee:Chat"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل ثنائي اليوم مسبقاً","md",true )
else
Redis:del(Gold.."Gold:Althnaee:Chat"..msg.chat_id)
Redis:del(Gold.."ThnaeeDay:ex"..msg.chat_id)
Redis:del(Gold.."ThnaeeDay:nameone"..msg.chat_id)
Redis:del(Gold.."ThnaeeDay:nametwo"..msg.chat_id)
Redis:del(Gold.."ThnaeeDay:idone"..msg.chat_id)
Redis:del(Gold.."ThnaeeDay:idtwo"..msg.chat_id)
...
if Redis:get(Gold.."Gold:Althnaee:Chat"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل ثنائي اليوم مسبقاً","md",true )
else
Redis:set(Gold.."Gold:Althnaee:Chat"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ ابشر فعلت ثنائي اليوم","md",true )
end
end
if text == "ثنائي اليوم" or text == "ثنائي" and Redis:get(Gold.."Gold:Althnaee:Chat"..msg.chat_id) then
if Redis:sismember(Gold.."Gold:Text:Cmd:Lock"..msg_chat_id,text) then
if Locks_Status(msg.sender_id.user_id,msg,text) ~= "noon" then
return send(msg_chat_id,msg_id,Locks_Status(msg.sender_id.user_id,msg,text),"md",true)
end
end
if Redis:get(Gold.."ThnaeeDay:ex"..msg.chat_id) then
ThnaeeDaynameone = Redis:get(Gold.."ThnaeeDay:nameone"..msg.chat_id)
ThnaeeDaynametwo = Redis:get(Gold.."ThnaeeDay:nametwo"..msg.chat_id)
ThnaeeDayidone = Redis:get(Gold.."ThnaeeDay:idone"..msg.chat_id)
ThnaeeDayidtwo = Redis:get(Gold.."ThnaeeDay:idtwo"..msg.chat_id)
if tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) >= 83000 then
hourthn = "23 ساعة"
elseif tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) >= 77400 then
hourthn = "21 ساعة"
elseif tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) >= 70200 then
hourthn = "19 ساعة"
elseif tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) >= 63000 then
hourthn = "17 ساعة"
elseif tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) >= 55800 then
hourthn = "15 ساعة"
elseif tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) >= 48600 then
hourthn = "13 ساعة"
elseif tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) >= 41400 then
hourthn = "11 ساعة"
elseif tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) >= 34200 then
hourthn = "9 ساعات"
elseif tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) >= 27000 then
hourthn = "7 ساعات"
elseif tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) >= 19800 then
hourthn = "5 ساعات"
elseif tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) >= 12600 then
hourthn = "3 ساعات"
elseif tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) >= 3600 then
hourthn = "ساعتين"
elseif tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) <= 3599 then
hourthn = "ساعة"
else
...
Redis:set(Gold.."ThnaeeDay:nameone"..msg.chat_id,FlterBio(UserInfo.first_name))
Redis:set(Gold.."ThnaeeDay:nametwo"..msg.chat_id,FlterBio(UserInfoo.first_name))
Redis:set(Gold.."ThnaeeDay:idone"..msg.chat_id,UserInfo.id)
Redis:set(Gold.."ThnaeeDay:idtwo"..msg.chat_id,UserInfoo.id)
Redis:setex(Gold.."ThnaeeDay:ex"..msg.chat_id,86400,true)
return send(msg.chat_id,msg.id,listTow,"md",true)  
end
if Redis:get(Gold.."Gold:Althnaee:Chat"..msg.chat_id) and tonumber(Redis:ttl(Gold.."ThnaeeDay:ex"..msg.chat_id)) <= 1 then
local Info_Members = bot.searchChatMembers(msg.chat_id, "*", 200)
local List_Members = Info_Members.members
local NumRand1 = math.random(1, #List_Members); 
local NumRand2 = math.random(1, #List_Members); 
...
if Redis:get(Gold.."azkarhourr"..msg.chat_id) then
return send(msg.chat_id,msg.id,"⇜ تم تفعيل الاذكار مسبقاً ","md",true)
else
Redis:setex(Gold.."azkarhour"..msg.chat_id,3600,true)
Redis:set(Gold.."azkarhourr"..msg.chat_id,"true")
...
if Redis:get(Gold.."azkarhourr"..msg.chat_id) then
Redis:del(Gold.."azkarhour"..msg.chat_id)
Redis:del(Gold.."azkarhourr"..msg.chat_id)
...
if Redis:get(Gold.."azkarhourr"..msg.chat_id) and tonumber(Redis:ttl(Gold.."azkarhour"..msg.chat_id)) <= 1 then

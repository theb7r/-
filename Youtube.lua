...
if Redis:get(Gold.."youtubee"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل اليوتيوب مسبقاً","md",true )
else
Redis:set(Gold.."youtubee"..msg.chat_id,"true")
...
Redis:set(Gold.."soshle"..msg.chat_id,"true")
...
if not Redis:get(Gold.."soshle"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم "..text.." مسبقاً","md",true )
else
Redis:del(Gold.."soshle"..msg.chat_id)
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم "..text.." ","md",true )
end
end
...
Redis:set(Gold.."sochal"..msg.chat_id,"true")
...
Redis:del(Gold.."soundidche"..msg.chat_id..msg.sender_id.user_id)
Redis:set(Gold.."soundidche"..msg.chat_id..msg.sender_id.user_id,search)
...
local jsonyou = JSON.decode(request("http://165.22.206.17:8000/get_video_data?url="..URL.escape(search)..""))
Redis:del(Gold.."youtidche"..msg.chat_id..msg.sender_id.user_id)
Redis:set(Gold.."youtidche"..msg.chat_id..msg.sender_id.user_id,search)
local datar = {data = {{text = "Louis", url = 'https://t.me/Y88F8'}}}
for i = 1,5 do

...
Redis:del(Gold.."lock_getpankiuserall") 
...
Redis:set(Gold.."lock_getpankiuserall",true)  
...
Redis:del(Gold.."lock_getpankiuser"..msg.chat_id) 
return send(msg_chat_id,msg_id,GetByName(msg).."*⇜ تم تفعيل لعبة البنك*","md",true )
end 
...
Redis:set(Gold.."lock_getpankiuser"..msg.chat_id,true)  
return send(msg_chat_id,msg_id,GetByName(msg).."*⇜ تم تعطيل لعبة البنك*","md",true )
end   
...
if not Redis:get(Gold.."lock_geamsAudio"..msg.chat_id) then 
return send(msg_chat_id,msg_id,GetByName(msg).."*⇜ تم تفعيل الصوتيات عام*","md",true )
else 
Redis:del(Gold.."lock_geamsAudio"..msg.chat_id) 
return send(msg_chat_id,msg_id,GetByName(msg).."*⇜ تم تفعيل الصوتيات عام*","md",true )
end 
end
...
if Redis:get(Gold.."lock_geamsAudio"..msg.chat_id) then 
return send(msg_chat_id,msg_id,GetByName(msg).."*⇜ تم تعطيل الصوتيات عام*","md",true )
else
Redis:set(Gold.."lock_geamsAudio"..msg.chat_id,true)  
return send(msg_chat_id,msg_id,GetByName(msg).."*⇜ تم تعطيل الصوتيات عام*","md",true )
end   
end
...
if not Redis:get(Gold.."lock_geamsAudio1"..msg.chat_id) then 
return send(msg_chat_id,msg_id,GetByName(msg).."*⇜ تم تفعيل الصوتيات*","md",true )
else 
Redis:del(Gold.."lock_geamsAudio1"..msg.chat_id) 
return send(msg_chat_id,msg_id,GetByName(msg).."*⇜ تم تفعيل الصوتيات*","md",true )
end 
end
...
if Redis:get(Gold.."lock_geamsAudio1"..msg.chat_id) then 
return send(msg_chat_id,msg_id,GetByName(msg).."*⇜ تم تعطيل الصوتيات*","md",true )
else
Redis:set(Gold.."lock_geamsAudio1"..msg.chat_id,true)  
return send(msg_chat_id,msg_id,GetByName(msg).."*⇜ تم تعطيل الصوتيات*","md",true )
end   
end
...
if not Redis:get(Gold.."Gold:AlThther:Chat"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل التحذير","md",true )
else
Redis:del(Gold.."Gold:AlThther:Chat"..msg.chat_id)
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل التحذير","md",true )
end
end
...
if Redis:get(Gold.."Gold:AlThther:Chat"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل التحذير","md",true )
else
Redis:set(Gold.."Gold:AlThther:Chat"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل التحذير","md",true )
end
end
...
if not Redis:get(Gold.."Gold:Alzwag:Chat"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ امـر زوجنـي معطـل مسبقـاً","md",true )
else
Redis:del(Gold.."Gold:Alzwag:Chat"..msg.chat_id)
...
if Redis:get(Gold.."Gold:Alzwag:Chat"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ امـر زوجنـي مفعـل مسبقـاً","md",true )
else
Redis:set(Gold.."Gold:Alzwag:Chat"..msg.chat_id,"true")
...
if Redis:get(Gold.."AutoTag"..msg_chat_id) then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ امـر التاك التلقـائـي مفعـل مسبقـاً","md",true )
else
Redis:set(Gold.."AutoTag"..msg_chat_id,"on") 
Redis:setex(Gold.."AutoTagTime"..msg_chat_id,150,true) 
...
Redis:del(Gold.."Gold:sh3ir:Abs"..msg.chat_id) 
end
...
Redis:set(Gold.."Gold:sh3ir:Abs"..msg.chat_id,true)  
end
...
Redis:del(Gold.."Gold:biousers"..msg.chat_id) 
end
...
Redis:set(Gold.."Gold:biousers"..msg.chat_id,true)  
end
...
Redis:set(Gold.."trfeh"..msg.chat_id,"true")
Redis:set(Gold.."amrthshesh"..msg.chat_id,"true")
...
if not Redis:get(Gold.."trfeh"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل التسليه مسبقاً","md",true )
else
Redis:del(Gold.."trfeh"..msg.chat_id)
Redis:del(Gold.."amrthshesh"..msg.chat_id)
...
if not Redis:get(Gold.."replayallbot"..msg.chat_id) then
Redis:del(Gold.."Gold:Gold:iraqq"..msg.chat_id) 
Redis:del(Gold.."Gold:Gold:yemenn"..msg.chat_id) 
Redis:del(Gold.."Gold:Gold:egibtt"..msg.chat_id) 
Redis:del(Gold.."Gold:Gold:syriaa"..msg.chat_id) 
Redis:del(Gold.."Gold:Gold:ksaa"..msg.chat_id)
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل ردود البوت مسبقاً","md",true )
else
Redis:del(Gold.."replayallbot"..msg.chat_id)
Redis:del(Gold.."Gold:Gold:iraqq"..msg.chat_id) 
Redis:del(Gold.."Gold:Gold:yemenn"..msg.chat_id) 
Redis:del(Gold.."Gold:Gold:egibtt"..msg.chat_id) 
Redis:del(Gold.."Gold:Gold:syriaa"..msg.chat_id) 
...
Redis:set(Gold.."replayallbot"..msg.chat_id,true)
...
if Redis:get(Gold.."spammkick"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."*⇜ تم فتـح الخيانـه مسبقاً*","md",true )
else
Redis:set(Gold.."spammkick"..msg.chat_id,"true")
...
if not Redis:get(Gold.."spammkick"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."*⇜ تم قفـل الخيانـه مسبقاً*","md",true )
else
Redis:del(Gold.."spammkick"..msg.chat_id)
...
if (Redis:get(Gold.."tagall@all"..msg.chat_id) == "open") then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تفعيل امر @all مسبقاً","md",true )
else
Redis:set(Gold.."tagall@all"..msg.chat_id,"open") 
...
if (Redis:get(Gold.."tagall@all"..msg.chat_id) == "close") then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تعطيل امر @all مسبقاً","md",true )
else
Redis:set(Gold.."tagall@all"..msg.chat_id,"close") 
...
if (Redis:get(Gold.."tagallgroup"..msg.chat_id) == "open") then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تفعيل امر التاق مسبقاً","md",true )
else
Redis:set(Gold.."tagallgroup"..msg.chat_id,"open") 
...
if (Redis:get(Gold.."tagallgroup"..msg.chat_id) == "close") then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تعطيل امر التاق مسبقاً","md",true )
else
Redis:set(Gold.."tagallgroup"..msg.chat_id,"close") 
...
if Redis:get(Gold.."kadmeat"..msg.chat_id)  then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تعطيل اوامر الصيغ مسبقاً","md",true )
else
Redis:set(Gold.."kadmeat"..msg.chat_id,"true")
...
if not Redis:get(Gold.."kadmeat"..msg.chat_id)  then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تفعيل اوامر التحويلات مسبقاً","md",true )
else
Redis:del(Gold.."kadmeat"..msg.chat_id)
...
if Redis:get(Gold.."intg"..msg.chat_id)  then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تعطيل امر انطق مسبقاً","md",true )
else
Redis:set(Gold.."intg"..msg.chat_id,"true")
...
if not Redis:get(Gold.."intg"..msg.chat_id)  then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تفعيل امر انطق مسبقاً","md",true )
else
Redis:del(Gold.."intg"..msg.chat_id)
...
if Redis:get(Gold.."brjj"..msg.chat_id)  then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تعطيل امر الابراج مسبقاً","md",true )
else
Redis:set(Gold.."brjj"..msg.chat_id,"true")
...
if not Redis:get(Gold.."brjj"..msg.chat_id)  then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تفعيل امر الابراج مسبقاً","md",true )
else
Redis:del(Gold.."brjj"..msg.chat_id)
...
if Redis:get(Gold.."idnotmemname"..msg.chat_id)  then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تعطيل امر اسمي مسبقاً","md",true )
else
Redis:set(Gold.."idnotmemname"..msg.chat_id,"true")
...
if not Redis:get(Gold.."idnotmemname"..msg.chat_id)  then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تفعيل امر اسمي مسبقاً","md",true )
else
Redis:del(Gold.."idnotmemname"..msg.chat_id)
...
if Redis:get(Gold.."idnotmembio"..msg.chat_id)  then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تعطيل امر البايو مسبقاً","md",true )
else
Redis:set(Gold.."idnotmembio"..msg.chat_id,"true")
...
if not Redis:get(Gold.."idnotmembio"..msg.chat_id)  then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تفعيل امر البايو مسبقاً","md",true )
else
Redis:del(Gold.."idnotmembio"..msg.chat_id)
...
if Redis:get(Gold.."idnotmem"..msg.chat_id)  then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تعطيل امر ايدي العضو مسبقاً","md",true )
else
Redis:set(Gold.."idnotmem"..msg.chat_id,"true")
...
if not Redis:get(Gold.."idnotmem"..msg.chat_id)  then
send(msg_chat_id,msg_id, GetByName(msg).."⇜ تم تفعيل امر ايدي العضو مسبقاً","md",true )
else
Redis:del(Gold.."idnotmem"..msg.chat_id)
...
Redis:del(Gold.."Abs:gif:Abs"..msg.chat_id) 
end
...
Redis:set(Gold.."Abs:gif:Abs"..msg.chat_id,true)  
end
...
Redis:del(Gold.."Abs:memz:Abs"..msg.chat_id) 
end
...
Redis:set(Gold.."Abs:memz:Abs"..msg.chat_id,true)  
end
...
Redis:del(Gold.."Abs:Remix:Abs"..msg.chat_id) 
end
...
Redis:set(Gold.."Abs:Remix:Abs"..msg.chat_id,true)  
end
...
Redis:del(Gold.."Abs:Photo:Abs"..msg.chat_id) 
end
...
Redis:set(Gold.."Abs:Photo:Abs"..msg.chat_id,true)  
end
...
Redis:del(Gold.."Abs:Anime:Abs"..msg.chat_id) 
end
...
Redis:set(Gold.."Abs:Anime:Abs"..msg.chat_id,true)  
end
...
Redis:del(Gold.."Abs:Movies:Abs"..msg.chat_id) 
end
...
Redis:set(Gold.."Abs:Movies:Abs"..msg.chat_id,true)  
end
...
Redis:del(Gold.."Abs:Series:Abs"..msg.chat_id) 
end
...
Redis:set(Gold.."Abs:Series:Abs"..msg.chat_id,true)  
end
...
Redis:set(Gold.."Gold:Status:joinet"..msg_chat_id,true) 
...
Redis:del(Gold.."Gold:Status:joinet"..msg_chat_id) 
...
if Redis:get(Gold.."Redis:setRt"..msg.chat_id)  then
send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل رتب التسليه مسيقاً","md",true )
else
Redis:set(Gold.."Redis:setRt"..msg.chat_id,"true")
...
if not Redis:get(Gold.."Redis:setRt"..msg.chat_id)  then
send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل رتب التسليه مسبقاً","md",true )
else
Redis:del(Gold.."Redis:setRt"..msg.chat_id)
...
Redis:set(Gold.."Gold:Status:Link"..msg_chat_id,true) 
...
Redis:set(Gold.."Gold:Status:Welcome"..msg_chat_id,true) 
...
if Redis:get(Gold.."Gold:TheBasicsQ:Aiid"..msg_chat_id) then
...
if Redis:get(Gold.."Gold:TheBasics:Aiid"..msg_chat_id) then
return send(msg_chat_id,msg_id,"*⇜ تفعيل الايدي معطـل من قبـل المالك الاساسي\n⇜ مخصص فقـط لـ المالك واعلى*","md",true)
end
end
if not msg.TheBasics or not msg.TheMasics then
if Redis:get(Gold.."Gold:Originators:Aiid"..msg_chat_id) then
return send(msg_chat_id,msg_id,"*⇜ تفعيل الايدي معطـل من قبـل المالك الاساسي\n⇜ مخصص فقـط لـ المنشئ الاساسي واعلى*","md",true)
end
end
if not msg.Originators or not msg.Origimators then
if Redis:get(Gold.."Gold:Managers:Aiid"..msg_chat_id) then
...
Redis:set(Gold.."Gold:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Gold.."Gold:Status:Reply"..msg_chat_id,true) 
...
Redis:set(Gold.."Gold:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Gold.."Gold:Status:BanId"..msg_chat_id,true) 
...
Redis:set(Gold.."Gold:Status:SetId"..msg_chat_id,true) 
...
Redis:set(Gold.."Gold:Status:Games"..msg_chat_id,true) 
...
Redis:set(Gold.."Gold:Status:KickMe"..msg_chat_id,true) 
...
Redis:set(Gold.."Gold:BotFree",true) 
...
Redis:set(Gold.."Gold:TwaslBot",true) 
...
Redis:del(Gold.."Gold:Status:Link"..msg_chat_id) 
...
Redis:del(Gold.."Gold:Status:Welcome"..msg_chat_id) 
...
Redis:del(Gold.."Gold:Status:Id"..msg_chat_id) 
...
Redis:del(Gold.."Gold:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Gold.."Gold:Status:Reply"..msg_chat_id) 
...
Redis:del(Gold.."Gold:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Gold.."Gold:Status:BanId"..msg_chat_id) 
...
Redis:del(Gold.."Gold:Status:SetId"..msg_chat_id) 
...
Redis:del(Gold.."Gold:Status:Games"..msg_chat_id) 
...
Redis:del(Gold.."Gold:Status:KickMe"..msg_chat_id) 
...
if not Redis:get(Gold.."Gold:Aldel:Chat"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل امر امسح","md",true )
else
Redis:del(Gold.."Gold:Aldel:Chat"..msg.chat_id)
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل امر امسح","md",true )
end
end
...
if Redis:get(Gold.."Gold:Aldel:Chat"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل امر امسح","md",true )
else
Redis:set(Gold.."Gold:Aldel:Chat"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل امر امسح","md",true )
end
end
...
Redis:del(Gold.."Gold:Status:Games:malk"..msg_chat_id) 
...
Redis:set(Gold.."Gold:Status:Games:malk"..msg_chat_id,true) 
...
Redis:del(Gold.."Gold:Status:repleall") 
...
Redis:set(Gold.."Gold:Status:repleall",true) 
...
Redis:del(Gold.."Gold:Status:Del:Media"..msg.chat_id)
...
Redis:set(Gold.."Gold:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(Gold.."Gold:Nzlne:Abs"..msg.chat_id) 
end
...
Redis:set(Gold.."Gold:Nzlne:Abs"..msg.chat_id,true)  
end
...
if Redis:get(Gold.."myphoto"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل امر صورتي .. مسبقاً","md",true )
else
Redis:set(Gold.."myphoto"..msg.chat_id,"true")
...
if not msg.MalekAsase or not msg.MalemAsase then
if Redis:get(Gold.."Gold:TheBasicsQ:Aftary"..msg_chat_id) then
return send(msg_chat_id,msg_id,"*⇜ تفعيل افتاري معطـل من قبـل المالك الاساسي\n⇜ مخصص فقـط لـ المالك الاسـاسي*","md",true)
end
end
if not msg.TheBasicsQ or not msg.TheMasicsQ then
if Redis:get(Gold.."Gold:TheBasics:Aftary"..msg_chat_id) then
return send(msg_chat_id,msg_id,"*⇜ تفعيل افتاري معطـل من قبـل المالك الاساسي\n⇜ مخصص فقـط لـ المالك واعلى*","md",true)
end
end
if not msg.TheBasics or not msg.TheMasics then
if Redis:get(Gold.."Gold:Originators:Aftary"..msg_chat_id) then
return send(msg_chat_id,msg_id,"*⇜ تفعيل افتاري معطـل من قبـل المالك الاساسي\n⇜ مخصص فقـط لـ المنشئ الاساسي واعلى*","md",true)
end
end
if not msg.Originators or not msg.Origimators then
if Redis:get(Gold.."Gold:Managers:Aftary"..msg_chat_id) then
return send(msg_chat_id,msg_id,"*⇜ تفعيل افتاري معطـل من قبـل المالك الاساسي\n⇜ مخصص فقـط لـ المنشئ واعلى*","md",true)
end
end
if not Redis:get(Gold.."myphoto"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل امر صورتي .. مسبقاً","md",true )
else
Redis:del(Gold.."myphoto"..msg.chat_id)
...
if Redis:get(Gold.."kolklma"..msg.chat_id) then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل امر قول .. مسبقـاً","md",true )
else
Redis:set(Gold.."kolklma"..msg.chat_id,"true")
...
if not Redis:get(Gold.."kolklma"..msg.chat_id) then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل امر قول .. مسبقـاً","md",true )
else
Redis:del(Gold.."kolklma"..msg.chat_id)
...
if Redis:get(Gold.."myages"..msg.chat_id) then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل حساب العمر","md",true )
else
Redis:set(Gold.."myages"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل حساب العمر","md",true )
end
end
...
Redis:del(Gold.."myages"..msg.chat_id)
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل حساب العمر","md",true )
end
end
...
if Redis:get(Gold.."myniknea"..msg.chat_id) then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل امر اغنيه","md",true )
else
Redis:set(Gold.."myniknea"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل امر اغنيه","md",true )
end
end
...
if not Redis:get(Gold.."myniknea"..msg.chat_id)  then
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل امر اغنيه","md",true )
else
Redis:del(Gold.."myniknea"..msg.chat_id)
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل امر اغنيه","md",true )
end
end
-----------------
...
Redis:set(Gold.."rebomsg"..msg.chat_id,true)
end
...
Redis:del(Gold.."rebomsg"..msg.chat_id)
end
-----------------
...
Redis:set(Gold.."Bots:Lock:ProNames"..msg.chat_id,true)
end
...
Redis:del(Gold.."Bots:Lock:ProNames"..msg.chat_id)
end
...
if not Redis:get(Gold.."lock_altfael"..msg.chat_id) then 
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل امر التفاعل","md",true )
else 
Redis:del(Gold.."lock_altfael"..msg.chat_id) 
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل امر التفاعل","md",true )
end 
end
...
if Redis:get(Gold.."lock_altfael"..msg.chat_id) then 
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل امر التفاعل","md",true )
else
Redis:set(Gold.."lock_altfael"..msg.chat_id,true)  
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل امر التفاعل","md",true )
end   
end
...
if not Redis:get(Gold.."lock_getadmin"..msg.chat_id) then 
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ نداء المالك مفعـل مسبقـاً","md",true )
else 
Redis:del(Gold.."lock_getadmin"..msg.chat_id) 
...
Redis:set(Gold.."lock_getadmin"..msg.chat_id,true)  
...
if not Redis:get(Gold.."lock_repleyadded"..msg.chat_id) then 
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل الردود المتعدده","md",true )
else 
Redis:del(Gold.."lock_repleyadded"..msg.chat_id) 
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تفعيل الردود المتعدده","md",true )
end 
end
...
if Redis:get(Gold.."lock_repleyadded"..msg.chat_id) then 
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل الردود المتعدده","md",true )
else
Redis:set(Gold.."lock_repleyadded"..msg.chat_id,true)  
return send(msg_chat_id,msg_id,GetByName(msg).."⇜ تم تعطيل الردود المتعدده*","md",true )
end   
end
...
Redis:set(Gold..'tagallgroup'..msg.chat_id,'open') 
Redis:set(Gold..'tagall@all'..msg.chat_id,'open') 
Redis:del(Gold.."knele"..msg.chat_id)
Redis:set(Gold.."Gold:Status:Link"..msg_chat_id,true) 
Redis:set(Gold.."Gold:Status:Welcome"..msg_chat_id,true) 
Redis:set(Gold.."Gold:Status:BanId"..msg_chat_id,true) 
Redis:set(Gold.."Gold:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:del(Gold.."intg"..msg.chat_id)
Redis:del(Gold.."kadmeat"..msg.chat_id)
Redis:del(Gold.."zhrfa"..msg.chat_id)
Redis:del(Gold.."brjj"..msg.chat_id)
Redis:del(Gold.."idnotmembio"..msg.chat_id)
Redis:del(Gold.."idnotmem"..msg.chat_id)
Redis:del(Gold..'lock_geamsAudio1'..msg.chat_id) 
...
Redis:del(Gold.."zed:hms"..msg_chat_id)
...
Redis:set(Gold.."zed:hms"..msg_chat_id,"off")
...
Redis:del(Gold.."zed:ehmsli"..msg_chat_id)
...
Redis:set(Gold.."zed:ehmsli"..msg_chat_id,"off")
...
Redis:del(Gold.."zed:zagel"..msg_chat_id)
...
Redis:set(Gold.."zed:zagel"..msg_chat_id,"off")
...
Redis:set(Gold.."Gold:Lock:tphlesh"..msg_chat_id,true) 
Redis:del(Gold.."Gold:Status:IdPhoto"..msg_chat_id)
Redis:set(Gold.."myphoto"..msg.chat_id,"true")
Redis:set(Gold.."porn"..msg.chat_id,"true")
Redis:del(Gold.."spammkick"..msg.chat_id)
...
Redis:del(Gold.."Gold:Lock:tphlesh"..msg_chat_id)  
Redis:set(Gold.."Gold:Status:IdPhoto"..msg_chat_id,true)
Redis:del(Gold.."myphoto"..msg_chat_id)
Redis:del(Gold.."porn"..msg_chat_id)
...
if not Redis:get(Gold..'porn'..msg.chat_id) then
...
Redis:del (Gold.."Gold:TheBasicsQQ:UpId"..msg_chat_id) 
Redis:del (Gold.."Gold:TheBasicsQ:UpId"..msg_chat_id) 
Redis:del (Gold.."Gold:TheBasics:UpId"..msg_chat_id) 
Redis:del (Gold.."Gold:Originators:UpId"..msg_chat_id) 
Redis:del (Gold.."Gold:Managers:UpId"..msg_chat_id)
...
Redis:del (Gold.."Gold:TheBasicsQQ:DWId"..msg_chat_id) 
Redis:del (Gold.."Gold:TheBasicsQ:DWId"..msg_chat_id) 
Redis:del (Gold.."Gold:TheBasics:DWId"..msg_chat_id) 
Redis:del (Gold.."Gold:Originators:DWId"..msg_chat_id) 
Redis:del (Gold.."Gold:Managers:DWId"..msg_chat_id)
...
Redis:set(Gold.."Status:Aktmooh"..msg.chat_id,true) 
...
Redis:del(Gold.."lock_iktmo"..msg.chat_id)  
...
Redis:del(Gold.."lock_inthare"..msg.chat_id) 
...
Redis:set(Gold.."lock_inthare"..msg.chat_id,true)  
...
Redis:set(Gold.."Gold:Lock:farsia"..msg_chat_id,true) 
...
Redis:del(Gold.."Gold:Lock:farsia"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:text"..msg_chat_id,true) 
...
Redis:set(Gold.."Gold:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Gold:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Lock:JoinFarsi"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Gold:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Gold:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Gold.."Gold:lockpin"..msg_chat_id,(bot.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Gold.."Gold:Lock:edittext"..msg_chat_id,true) 
...
Redis:set(Gold.."Gold:Lock:edit"..msg_chat_id,true) 
...
Redis:set(Gold.."Gold:Lock:Markdaun"..msg_chat_id,"del")  
Redis:set(Gold.."Gold:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Gold..'Gold:'..lock..msg_chat_id,"del")    
end
...
Redis:set(Gold.."Gold:Lock:AlUasat"..msg_chat_id,"del")  
...
Redis:del(Gold.."Gold:Lock:AlUasat"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:Animation"..msg_chat_id,"del")  
Redis:set(Gold.."Gold:Lock:Photo"..msg_chat_id,"del")  
Redis:set(Gold.."Gold:Lock:vico"..msg_chat_id,"del")  
Redis:set(Gold.."Gold:Lock:Audio"..msg_chat_id,"del")  
Redis:set(Gold.."Gold:Lock:Sticker"..msg_chat_id,"del")  
Redis:set(Gold.."Gold:Lock:Video"..msg_chat_id,"del") 
Redis:del(Gold.."Gold:Status:IdPhoto"..msg_chat_id)
Redis:set(Gold.."myphoto"..msg.chat_id,"true") 
...
Redis:del(Gold.."Gold:Lock:Animation"..msg_chat_id)  
Redis:del(Gold.."Gold:Lock:Photo"..msg_chat_id)  
Redis:del(Gold.."Gold:Lock:vico"..msg_chat_id)  
Redis:del(Gold.."Gold:Lock:Audio"..msg_chat_id)  
Redis:del(Gold.."Gold:Lock:Sticker"..msg_chat_id)  
Redis:del(Gold.."Gold:Lock:Video"..msg_chat_id) 
Redis:set(Gold.."Gold:Status:IdPhoto"..msg_chat_id,true)
Redis:del(Gold.."myphoto"..msg_chat_id)  
...
Redis:del(Gold.."Gold:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Gold.."Gold:Lock:text"..msg_chat_id)  
...
Redis:del(Gold.."Gold:Lock:Join"..msg_chat_id)  
...
Redis:del(Gold.."Lock:JoinFarsi"..msg_chat_id)  
...
Redis:del(Gold.."Gold:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Gold.."Gold:Lock:tagservr"..msg_chat_id)  
...
Redis:del(Gold.."Gold:lockpin"..msg_chat_id)  
...
Redis:del(Gold.."Gold:Lock:edittext"..msg_chat_id) 
...
Redis:del(Gold.."Gold:Lock:edit"..msg_chat_id) 
...
Redis:del(Gold.."Gold:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Gold..'Gold:'..lock..msg_chat_id)    
end
...
Redis:hset(Gold.."Gold:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Gold.."Gold:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Gold.."Gold:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Gold.."Gold:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Gold.."Gold:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Gold.."Gold:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:Link"..msg_chat_id)  
...
Redis:set(Gold.."Lock:Taifia"..msg_chat_id,"del")  
...
Redis:set(Gold.."Lock:Taifia"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Lock:Taifia"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Lock:Taifia"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Lock:Taifia"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:User:Name"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:hashtak"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:Cmd"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Gold:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Video"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Gold:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Gold:Lock:Jmthon"..msg_chat_id,"ktm")
Redis:del(Gold.."spammkick"..msg.chat_id)
...
Redis:del(Gold.."Gold:Lock:Jmthon"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:Takleed"..msg_chat_id,"ktm")
...
Redis:del(Gold.."Gold:Lock:Takleed"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:geam"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Gold:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:vico"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Gold:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:set(Gold.."Gold:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:forward"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:Document"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:Contact"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:Spam"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Gold.."Gold:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Gold.."Gold:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Gold.."Gold:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Gold.."Gold:Lock:Inlen"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:SenderChat"..msg_chat_id,true) 
...
Redis:del(Gold.."Gold:Lock:SenderChat"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:phshar"..msg_chat_id,true) 
...
Redis:del(Gold.."Gold:Lock:phshar"..msg_chat_id)  
...
Redis:set(Gold.."Gold:Lock:english"..msg_chat_id,true) 
...
Redis:del(Gold.."Gold:Lock:english"..msg_chat_id) 

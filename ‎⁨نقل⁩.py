...
bot = telebot.TeleBot('8004971819:AAFy9QwPCOMmpQjNTRoGPNd4LgVXc4Sa_7o') #ضع توكن بوتك بدل كلمه token
...
# --------------------- حقوقي ممنوع تغير  ---------------------#
    ...
    button_developer = types.InlineKeyboardButton("المطور", url="https://t.me/CH_XE")
...
اهلا بك عزيزي في بوت نقل الاعضاء مقدم من @CH_XE
